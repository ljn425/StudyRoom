				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<!-- form start -->
							<form id="modifyForm" role="form" action="${pageContext.request.contextPath}/staff/staff_modify" method="post">
								<div class="box-body">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="${staff.branch_owner_cd}" name="branch_owner_cd" readonly>
									</div>
									<div class="form-group">
									...
									<div>
										<input type="text" id="staff_postcode" value="${staff.staff_postcode}" name="staff_postcode" placeholder="우편번호">
										<input type="button"  onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
										<input type="text" id="staff_addr" value="${staff.staff_addr}" name="staff_addr" class="form-control" placeholder="주소">
										<input type="text" id="staff_detail_addr" value="${staff.staff_detail_addr}" name="staff_detail_addr" class="form-control"  placeholder="상세주소">
									</div>	
								...
								<div class="box-footer">
									<button id="modifybutton"  type="button" class="btn btn-primary">글수정</button>
