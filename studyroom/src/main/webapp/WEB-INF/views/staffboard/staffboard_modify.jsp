...
<div class="container">
    <h1>공지사항 수정</h1> 
    <form id="modifyform" class="form-horizontal" action="${pageContext.request.contextPath}/staffboard/staffboard_modify_pro" method="post">
        ...
        <div class="form-group">staffboard_content :
          ...
          <div class="box-footer">
                    <button id ="modifybutton" type="button" class="btn btn-primary">글입력</button>
